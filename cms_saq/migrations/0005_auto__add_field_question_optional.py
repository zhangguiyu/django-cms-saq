...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.optional'
        db.add_column('cmsplugin_question', 'optional', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.optional'
        db.delete_column('cmsplugin_question', 'optional')
