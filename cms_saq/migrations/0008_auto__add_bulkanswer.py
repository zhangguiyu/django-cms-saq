...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BulkAnswer'
        db.create_table('cmsplugin_bulkanswer', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('answer_value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('cms_saq', ['BulkAnswer'])


    def backwards(self, orm):
        
        # Deleting model 'BulkAnswer'
        db.delete_table('cmsplugin_bulkanswer')
