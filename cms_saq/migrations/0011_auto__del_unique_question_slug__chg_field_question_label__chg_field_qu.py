...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('cmsplugin_question', ['slug'])


        # Changing field 'Question.label'
        db.alter_column('cmsplugin_question', 'label', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'Question.help_text'
        db.alter_column('cmsplugin_question', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):
        # Adding unique constraint on 'Question', fields ['slug']
        db.create_unique('cmsplugin_question', ['slug'])


        # Changing field 'Question.label'
        db.alter_column('cmsplugin_question', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Question.help_text'
        db.alter_column('cmsplugin_question', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=255))
