...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SectionedScoring'
        db.create_table('cmsplugin_sectionedscoring', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('cms_saq', ['SectionedScoring'])

        # Adding model 'ScoreSection'
        db.create_table('cms_saq_scoresection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sections', to=orm['cms_saq.SectionedScoring'])),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cms_saq', ['ScoreSection'])


    def backwards(self, orm):
        
        # Deleting model 'SectionedScoring'
        db.delete_table('cmsplugin_sectionedscoring')

        # Deleting model 'ScoreSection'
        db.delete_table('cms_saq_scoresection')
