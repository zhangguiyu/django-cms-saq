...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormNav.end_page'
        db.add_column('cmsplugin_formnav', 'end_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='formnav_ends', null=True, to=orm['cms.Page']), keep_default=False)

        # Adding field 'FormNav.end_page_label'
        db.add_column('cmsplugin_formnav', 'end_page_label', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormNav.end_page'
        db.delete_column('cmsplugin_formnav', 'end_page_id')

        # Deleting field 'FormNav.end_page_label'
        db.delete_column('cmsplugin_formnav', 'end_page_label')
