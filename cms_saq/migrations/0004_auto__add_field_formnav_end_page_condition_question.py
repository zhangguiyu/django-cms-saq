...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormNav.end_page_condition_question'
        db.add_column('cmsplugin_formnav', 'end_page_condition_question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms_saq.Question'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormNav.end_page_condition_question'
        db.delete_column('cmsplugin_formnav', 'end_page_condition_question_id')
